...
- **[to-tickets](./skills/engineering/to-tickets/SKILL.md)** — Break any plan, spec, or conversation into a set of tracer-bullet tickets, each declaring its blocking edges — as markdown issues under `docs/issues/`, or as native blocking links on a real tracker.
