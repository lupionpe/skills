...
- **Local files** → one file per ticket under `docs/issues/<feature>/issues/`, numbered blockers-first, the edges written as text. You work the frontier by hand, staying in the loop.
